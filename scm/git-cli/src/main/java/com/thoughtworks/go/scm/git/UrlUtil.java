...
public class UrlUtil {
    ...
    public static String extractPassword(String url, Credentials credentials) {
        return firstNonBlank(getPassword(url), credentials != null ? credentials.getPassword() : "");
    }

    public static String extractUsername(String url, Credentials credentials) {
        return firstNonBlank(getUsername(url), credentials != null ? credentials.getUsername() : "");
    }
}
