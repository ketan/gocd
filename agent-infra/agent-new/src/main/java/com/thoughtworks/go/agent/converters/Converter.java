...
package com.thoughtworks.go.agent.converters;
...
import com.thoughtworks.go.protobufs.registration.AgentAutoRegistrationProto;
import com.thoughtworks.go.protobufs.registration.AgentMetaProto;

public class Converter {
    public static AgentAutoRegistrationProto toProto(AgentAutoRegistrationProperties autoRegistrationProperties) {
    ...
    public static AgentMetaProto toProto(AgentMeta agentMeta) {
