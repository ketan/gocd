...
public class GitCommandOld extends SCMCommand  implements GitCommand {
    ...
    GitCommandOld(String materialFingerprint, File workingDir, String branch, boolean isSubmodule, Map<String,
