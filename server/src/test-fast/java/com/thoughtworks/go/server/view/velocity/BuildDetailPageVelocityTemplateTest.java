...
//        TestVelocityView view = new TestVelocityView("/WEB-INF/vm/build_detail/build_detail_page.ftl", data);
//        view.setupAdditionalRealTemplate("shared/_header.ftl");
//        view.setupAdditionalRealTemplate("shared/_footer.ftl");
//        view.setupAdditionalRealTemplate("shared/_flash_message.ftl");
//        view.setupAdditionalRealTemplate("shared/_artifacts.ftl");
//        view.setupAdditionalRealTemplate("shared/_artifact_entry.ftl");
//        view.setupAdditionalRealTemplate("shared/_package_material_revision_comment.ftl");
//        view.setupAdditionalRealTemplate("shared/_job_details_breadcrumbs.ftl");
//
//        view.setupAdditionalRealTemplate("sidebar/_sidebar_build_list.ftl");
//
//        view.setupAdditionalRealTemplate("build_detail/_buildoutput.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_build_output_raw.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_tests.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_test_output_config.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_artifacts.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_materials.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_material_revisions_jstemplate.ftl");
//        view.setupAdditionalRealTemplate("build_detail/_build_detail_summary_jstemplate.ftl");
//
//        return view;
//    }
//}
