...
public class GitCommandOldTest {
    ...
    void setup() throws Exception {
        System.setProperty(GitCommandFactory.USE_OLD_EXECUTION_TOGGLE, "Y");
    ...
    void teardown() throws Exception {
        ...
        System.setProperty(GitCommandFactory.USE_OLD_EXECUTION_TOGGLE, "");
    }
    ...
    void shouldRetrieveListOfSubmoduleFolders() throws Exception {
        ...
        List<String> folders = ((GitCommandOld)gitWithSubmodule).submoduleFolders();
    ...
    void shouldNotThrowErrorWhenConfigRemoveSectionFails() throws Exception {
        GitRepoContainingSubmodule submoduleRepos = new GitRepoContainingSubmodule(temporaryFolder);
        submoduleRepos.addSubmodule(SUBMODULE, "sub1");
        GitCommand gitWithSubmodule = new GitCommandOld(null, createTempWorkingDirectory(), GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<>(), null) {
    ...
    private File checkInNewRemoteFileInFuture(Date checkinDate) throws IOException {
        GitCommandOld remoteGit = (GitCommandOld) GitCommandFactory.create(null, repoLocation, GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<>(), null);
        File testingFile = new File(repoLocation, "testing-file" + System.currentTimeMillis() + ".txt");
        testingFile.createNewFile();
        remoteGit.add(testingFile);
